...
//   const WorkshopsSection({Key? key}) : super(key: key);
...
//   const ClubsCard({Key? key, required this.title}) : super(key: key);
...
//   const WorkshopsCard({Key? key, required this.title}) : super(key: key);
